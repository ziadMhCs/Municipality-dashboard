...
//     return axios.get("https://tproject.techpundits.net/api/activity")
//       .then(response => {
...
const handleButtonClick = async (event) => {
  ...
  return (
    ...
    <p className="black_bold_h2 decisions-Title2">الفعاليات السابقة :</p>
    <EventCard  
    // refresh={getAllCardEvent}
    // cardarray={setServices}
